...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of email.send, email.suppression.add) and reuse it from your own code.
